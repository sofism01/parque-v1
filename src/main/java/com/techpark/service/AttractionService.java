...
public class AttractionService {
    ...
    public boolean deleteZone(Long zoneId) {
        ...
        List<Attraction> affectedAttractions = getAttractionsByZone(zoneId);
        for (Attraction attraction : affectedAttractions) {
            if (attraction == null) {
                continue;
            }

            attraction.setZoneId(null);
            attraction.setZone(null);
            attraction.setPosX(null);
            attraction.setPosY(null);
        }

        zones.entrySet().removeIf((entry) -> Objects.equals(entry.getKey(), zoneId));
        return true;
    }
