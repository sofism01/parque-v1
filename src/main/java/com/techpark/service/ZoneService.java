...
public class ZoneService {
    ...
    public OperationResult deleteZone(Long zoneId) {
        ...
        int removedAttractions = attractionService.getAttractionsByZone(zoneId).size();
        ...
        return new OperationResult(true, "Zona eliminada correctamente junto con " + removedAttractions + " atraccion(es)");
    }
